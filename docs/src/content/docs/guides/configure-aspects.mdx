...
And then, you can refer to this custom submodule from other aspects:
    ...
    homeManager =
      { config, ... }:
      {
        programs = {
          gpg = {
            enable = true;
            settings.default-key = den.aspects.${config.home.username}.default-key;
          };
        };
        ...
        services = {
          gpg-agent = {
            ...
            sshKeys = [
              den.aspects.${config.home.username}.keygrip
            ];
          };
        };
      };
