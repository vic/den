...
hero:
  ...
  actions:
    - text: NixOS Framework
      link: /explanation/context-pipeline
      icon: right-arrow
...
<LinkButton variant="secondary" href="/overview">Overview</LinkButton>
...
<CardGrid>
  ...
  <Card title="Bidirectional" icon="right-arrow">
    ...
    hosts. [Aspects flow in both directions](/guides/configure-aspects/) automatically.
  </Card>
