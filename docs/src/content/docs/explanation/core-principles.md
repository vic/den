...
The key insight: **the flow of data is declared separately from the
...
The key insight: **the shape of the function arguments determines when
configs are produced, without explicit conditionals**.
